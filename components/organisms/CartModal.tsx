...
const CartModal = () => {
  ...
  const { isCartModalOpen, onCartModalClose } = useCartModal();
          ...
          {items.length > 0 ? (
            <Box>
              ...
              <HStack justify="space-between" mb="1.5rem">
                ...
                <Text color="black" fontSize="1.125rem" fontWeight="bold">
            ...
            <Box
              textAlign="center"
              sx={{ svg: { display: "block", margin: "auto" } }}
            >
              <Text mb="1rem" fontSize="1rem" fontWeight="1rem">
                Your cart is empty
              </Text>
              <svg
                width="6rem"
